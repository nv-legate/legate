...
#endif
#else  // LEGATE_USE_WEAK
#define LEGATE_WEAK
#endif  // LEGATE_USE_WEAK

// NOLINTBEGIN
LEGATE_EXTERN LEGATE_WEAK Legate_MPI_Comm legate_mpi_comm_world(void);
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_thread_multiple(void);
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_tag_ub(void);
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_congruent(void);
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_success(void);
...
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_init_thread(int* argc,
                                                     ...
                                                     int required,
                                                     int* provided);
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_finalize(void);
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_abort(Legate_MPI_Comm comm, int error_code);
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_initialized(int* init);
...
LEGATE_EXTERN LEGATE_WEAK int legate_mpi_send(const void* buf,
                                              int count,
