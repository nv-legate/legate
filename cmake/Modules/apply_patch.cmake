...
function(legate_core_generate_patch_command)
  ...
  cmake_parse_arguments(_LEGATE_CORE_GEN_PATCH_CMD "${options}" "${one_value_args}"
  ...
  set(${_LEGATE_CORE_GEN_PATCH_CMD_DEST_VAR}
      ${Patch_EXECUTABLE} ${input_file} -N --input=${patch_file} --ignore-whitespace
      --quiet PARENT_SCOPE)
endfunction()
...
function(legate_core_apply_patch)
  ...
  set(multi_value_keywords)
  cmake_parse_arguments(_LEGATE_CORE_PATCH "${options}" "${one_value_args}"
                        "${multi_value_keywords}" ${ARGN})

  legate_core_generate_patch_command(
    SOURCE ${_LEGATE_CORE_PATCH_SOURCE} PATCH_FILE ${_LEGATE_CORE_PATCH_PATCH_FILE}
