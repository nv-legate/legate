...
function(legate_configure_default_compiler_flags)
  ...
  set(
    default_cxx_flags_relwithdebinfo
    ${default_cxx_flags_debug}
  ...
  if(NOT legate_CXX_FLAGS)
    legate_set_default_flags_impl(
      LANG CXX
      DEST_VAR legate_CXX_FLAGS
