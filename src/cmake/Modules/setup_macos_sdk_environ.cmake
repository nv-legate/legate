...
function(_set_macosx_sdkroot)
  ...
  if(DEFINED CMAKE_OSX_SYSROOT)
    message(VERBOSE "CMAKE_OSX_SYSROOT already set: ${CMAKE_OSX_SYSROOT}. "
            "Letting CMake detect defaults from it.")
    return()
  endif()
  ...
  execute_process(COMMAND ${LEGATE_XCRUN} --sdk macosx --show-sdk-path
                          COMMAND_ERROR_IS_FATAL ANY OUTPUT_VARIABLE sdk_root
