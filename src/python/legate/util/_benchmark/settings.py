...
class BenchmarkSettings(Settings):
    out: EnvOnlySetting[str] = EnvOnlySetting(
        ...
        convert=convert_str,
        help="""
            Where :py:func:`~legate.util.benchmark.benchmark_log` records
    ...
    use_rich: EnvOnlySetting[bool] = EnvOnlySetting(
        ...
        help="""
            Whether :py:func:`~legate.util.benchmark.benchmark_log` should use
            `rich <https://rich.readthedocs.io>`__ when the output stream is a
            tty.
