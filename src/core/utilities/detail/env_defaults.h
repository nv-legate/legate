...
#define LEGATE_MAX_PENDING_EXCEPTIONS_DEFAULT 1
#else
#define LEGATE_MAX_PENDING_EXCEPTIONS_DEFAULT 64
#endif
#define LEGATE_MAX_PENDING_EXCEPTIONS_TEST 1

#define LEGATE_PRECISE_EXCEPTION_TRACE_DEFAULT 0
#define LEGATE_PRECISE_EXCEPTION_TRACE_TEST 0
...
#define LEGATE_MAX_LRU_LENGTH_DEFAULT 5
#define LEGATE_MAX_LRU_LENGTH_TEST 1
