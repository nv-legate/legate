...
class BaseMapper : public Legion::Mapping::Mapper, public MachineQueryInterface {
 ...
 public:
  ...
  virtual const std::vector<Processor>& cpus() const override { return local_machine.cpus(); }
  virtual const std::vector<Processor>& gpus() const override { return local_machine.gpus(); }
  virtual const std::vector<Processor>& omps() const override { return local_machine.omps(); }
  virtual uint32_t total_nodes() const override { return local_machine.total_nodes; }
