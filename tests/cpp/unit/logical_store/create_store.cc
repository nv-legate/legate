...
INSTANTIATE_TEST_SUITE_P(
  ...
  ::testing::Values(
    ...
    std::make_tuple(legate::int32(), legate::Scalar{3}),
    std::make_tuple(legate::int64(), legate::Scalar{4L}),
    ...
    std::make_tuple(legate::uint32(), legate::Scalar{7U}),
    std::make_tuple(legate::uint64(), legate::Scalar{8UL}),
