...
**Note**
Packages are offered for Linux (x86_64 and aarch64), supporting Python versions
3.11 to 3.14, and for macOS (aarch64, pip wheels only), supporting Python
versions 3.11 to 3.13. Windows is only supported through WSL.
